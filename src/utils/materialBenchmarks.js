...
const normalizeBenchmarkHistoryEntry = (entry, index, material, context) => {
  ...
  return {
    ...
    actor: entry?.actor || entry?.updatedBy || context.verifiedBy || 'Quantra Market Review',
    changedAt,
...
const buildDefaultBenchmarkHistory = (material, context) => {
  ...
  return [{
    ...
    action: 'baseline',
    actor: context.verifiedBy || 'Quantra Market Review',
...
const normalizeApprovalSnapshotEntry = (entry, index, material, context) => {
  ...
  return {
    ...
    marketRead: clampNumber(entry?.marketRead ?? context.marketRead),
    approvedAt,
    approvedBy: entry?.approvedBy || context.approvedBy || context.verifiedBy || 'Quantra Market Review',
    actor: entry?.actor || entry?.approvedBy || context.approvedBy || context.verifiedBy || 'Quantra Market Review',
...
const buildDefaultApprovedSnapshot = (material, context) => {
  ...
  return [normalizeApprovalSnapshotEntry({
    ...
    approvedBy: context.approvedBy || context.verifiedBy || 'Quantra Market Review',
...
export const normalizeMaterialBenchmarkRecord = (material = {}) => {
  ...
  const benchmarkHistory = normalizeBenchmarkHistory(material, {
    ...
    approvalStatus,
    approvedBy: material.approvedBy || material.verifiedBy || 'Quantra Market Review',
    sourceCount,
    confidence,
