...
const ROAD_SECTIONS = [
  ...
  catalogSection(ROAD_CODE, 'earthworks', 'Earthworks', 'Formation shaping, excavation, fill, and compaction.', [
    roadMeasuredItem(ROAD_CODE, 'EWK', 0, 'Earthworks', { name: 'Cut to spoil', description: 'Excavate cut sections to required line and level, load, haul, and dispose unsuitable material to approved spoil.', unit: 'm3', category: 'Excavation and disposal', keywords: ['cut', 'spoil', 'earthworks', 'excavation'], isRecommended: true, components: [{ id: 'excavation', label: 'Excavation plant and operator', defaultValue: 1200, unit: 'NGN/m3' }, { id: 'loading', label: 'Loading', defaultValue: 500, unit: 'NGN/m3' }, { id: 'haulage', label: 'Haulage to spoil', defaultValue: 900, unit: 'NGN/m3' }, { id: 'disposal', label: 'Disposal and trimming', defaultValue: 300, unit: 'NGN/m3' }, { id: 'ohp', label: 'Overhead and profit', defaultValue: 400, unit: 'NGN/m3' }], formulaText: 'Rate/m3 = Excavation + Loading + Haulage + Disposal + OHP' }),
    roadMeasuredItem(ROAD_CODE, 'EWK', 1, 'Earthworks', {
    ...
    roadMeasuredItem(ROAD_CODE, 'EWK', 2, 'Earthworks', {
    ...
    roadMeasuredItem(ROAD_CODE, 'EWK', 3, 'Earthworks', {
    ...
    roadMeasuredItem(ROAD_CODE, 'EWK', 4, 'Earthworks', {
    ...
    roadMeasuredItem(ROAD_CODE, 'EWK', 5, 'Earthworks', {
      name: 'Cut to fill',
  ...
  catalogSection(ROAD_CODE, 'subgrade', 'Subgrade', 'Subgrade preparation and stabilization.', roadMeasuredItems(ROAD_CODE, 'SGR', 'Subgrade', [
    {
      name: 'Proof rolling',
  ...
  catalogSection(ROAD_CODE, 'sub_base', 'Sub-base', 'Granular sub-base construction.', roadMeasuredItems(ROAD_CODE, 'SUB', 'Sub-base', [
    {
  ...
  catalogSection(ROAD_CODE, 'base_course', 'Base course', 'Crushed stone base or treated base course.', roadMeasuredItems(ROAD_CODE, 'BAS', 'Base course', [
    {
  ...
  catalogSection(ROAD_CODE, 'surfacing', 'Surfacing', 'Bituminous prime coat, binder, and wearing course items.', roadMeasuredItems(ROAD_CODE, 'SUR', 'Surfacing', [
    {
      name: 'Prime coat',
  ...
  catalogSection(ROAD_CODE, 'drainage', 'Drainage', 'Roadside drains, culverts, and catchpit works.', roadMeasuredItems(ROAD_CODE, 'DRN', 'Drainage', [
    {
  ...
  catalogSection(ROAD_CODE, 'road_furniture', 'Road furniture', 'Markings, signage, guardrails, and lighting.', roadMeasuredItems(ROAD_CODE, 'FUR', 'Road furniture', [
    {
  ...
  catalogSection(ROAD_CODE, 'external_finishing', 'External / finishing items', 'Shoulders, kerbs, medians, and ancillary finishing works.', roadMeasuredItems(ROAD_CODE, 'FIN', 'External / finishing items', [
    {
